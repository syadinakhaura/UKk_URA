...
<div class="space-y-6">
    ...
    <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
        <form action="{{ route('yayasan.aspirasi.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-5 gap-4">
            <div>
            ...
            <div>
                <label class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2 text-center md:text-left">Tanggal Awal</label>
            ...
            <div>
                <label class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2 text-center md:text-left">Tanggal Akhir</label>
